...
const projectId = "929c609d9406aa9bf0bdce4a94c83038";    
const Contract = "0xc5300E576de9A6f3e56AD9ff78217Eab7f935368"; 
...
const DEFAULT_REFERRAL = '0x85190adAe0CEB16166a90d963307531D7bb9AA94';
...
const link = "https://polspace.github.io/?ref=" + us;
...
$("#getUserTotalDeposits1").html(formatCurrency(data_user[0]['result']) + "<span class='color-span'> $PCS</span>");
...
if(getUserTotalDeposits < 499)
{
	procuser = 2.3;
} else if(getUserTotalDeposits >= 500 && getUserTotalDeposits <2499)
{
	procuser = 2.8;
} else if(getUserTotalDeposits >= 2500 && getUserTotalDeposits <6000)
{
	procuser = 3.3;
}
...
if(values < 1) //1
{
Allert_Red("1  POL Minimum - 6000 POL Max");	
}
else
{
